...
public class AppSerializable {
    ...
    public void app(String FILE_BIN, String FILE_JSON, String FILE_XML, Student1 student) {
        ...
        try {
            ...
            student = objectMapper.readValue(fileJSON, Student1.class);
            ...
            student = xmlMapper.readValue(fileXML, Student1.class);
